...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
                ...
                <div class="shop-breadcrumb">
                    ...
                    <div class="breadcrumb-main">
                        ...
                        <div class="flex-wrap breadcrumb-action justify-content-center">
                            <a href="javascript:editModal('{{ route('category.index', ['language' => app()->getLocale()]) }}','category-form-modal','form-modal','Add Category')"
    ...
    <div class="container-fluid">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="mb-0 orderDatatable_actions d-flex float-end">
                                                    ...
                                                    <li>
                                                        <a href="javascript:editModal('{{ route('category.edit',$item->id, ['language' => app()->getLocale()]) }}','category-edit-modal','form-modal')"
                                                            class="edit">
                    ...
                    <div class="modal-body">
                        {{-- <div class="new-member-modal" id="form-modal"> --}}
                            ...
                            <div class="form-group mb-20">
                                <label for="example-text-input" class="col-form-label">Course Category Name</label>
        ...
        <!-- Modal -->
          ...
          <div class="modal fade new-member" id="category-edit-modal" role="dialog" tabindex="-1"
          aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content radius-xl">
                  <div class="modal-header">
                      <h6 class="modal-title fw-500" id="staticBackdropLabel">{{ trans('course.edit-category') }}</h6>
                      <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round" class="svg replaced-svg">
