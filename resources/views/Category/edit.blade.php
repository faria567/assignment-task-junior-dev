                 ...
                 <div class="form-group mb-20">
                     ...
                     <input class="form-control" type="text" name="title" value="{{old('title',$category->title)}}" id="example-text-input">
                     ...
                     <div class="ap-img pro_img_wrapper">
                         ...
                         <label for="file-upload">
                             <img class="ap-img__main rounded wh-120 bg-lighter d-flex"  
                                 src="{{ asset('assets/img/'.$category->image) }}" alt="profile" id="profile-priviewer">
