...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
            ...
            <div class="col-lg-12">
                <div class="shop-breadcrumb">
                    ...
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Project Sub Category</h4>

                        <div class="flex-wrap breadcrumb-action justify-content-center">
                            <a href="javascript:editModal('{{ route('subcategory.index', ['language' => app()->getLocale()]) }}','subcategory-form-modal','form-modal','Add Sub Category')"
                                class="btn btn-sm btn-primary me-0 radius-md">
                                <i class="la la-plus"></i> Add Project Sub Category</a>
    ...
    <div class="container-fluid">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="mb-0 orderDatatable_actions d-flex float-end">
                                                    ...
                                                    <li>
                                                        <a href="javascript:editModal('{{ route('subcategory.edit',$item->id, ['language' => app()->getLocale()]) }}','category-edit-modal','form-modal')"
                                                            class="edit">
        ...
        <div class="modal fade new-member" id="subcategory-form-modal" role="dialog" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content radius-xl">

                    <div class="modal-header">
                        <h6 class="modal-title fw-500" id="staticBackdropLabel">{{ trans('course.add-subcategory') }}</h6>
                    ...
                    <div class="modal-body">
                        {{-- <div class="new-member-modal" id="form-modal"> --}}
                                ...
                                <form class="form-valide" action="{{route('subcategory.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                            ...
                            <div class="form-group mb-20">
                                <label for="example-text-input" class="col-form-label">Course Sub Category Name</label>
                            ...
                            <div class="mb-4 account-profile d-flex align-items-center ">
                                <div class="ap-img pro_img_wrapper">
                                    <input id="file-upload" type="file" name="image" class="d-none"
                                        ...
                                        <input class="d-none" type="file" name="image" id="file-upload">
                                        @error('image')
                                            <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    ...
                                    <label for="file-upload">
                                        <img class="ap-img__main rounded wh-120 bg-lighter d-flex"
                                            src="{{ asset('assets/img/') }}" alt="profile" id="profile-priviewer">
        ...
        <!-- Modal -->
          ...
          <div class="modal fade new-member" id="subcategory-edit-modal" role="dialog" tabindex="-1"
          aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content radius-xl">
                  <div class="modal-header">
                      <h6 class="modal-title fw-500" id="staticBackdropLabel">{{ trans('course.edit-subcategory') }}</h6>
                      <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                              fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                              stroke-linejoin="round" class="svg replaced-svg">
