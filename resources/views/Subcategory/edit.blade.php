                     ...
                     <form class="form-valide" action="{{route('subcategory.update', $subcategory->id)}}" method="post" enctype="multipart/form-data">
                         @csrf
                         @method('PATCH')
         

                 <div class="form-group mb-20">
                     <label for="example-text-input" class="col-form-label">Course subcategory Name</label>
                     <input class="form-control" type="text" name="title" value="{{old('title',$subcategory->title)}}" id="example-text-input">
                     ...
                     <div class="ap-img pro_img_wrapper">
                         ...
                         <label for="file-upload">
                             <img class="ap-img__main rounded wh-120 bg-lighter d-flex"  
                                 src="{{ asset('assets/img/'.$subcategory->image) }}" alt="profile" id="profile-priviewer">
